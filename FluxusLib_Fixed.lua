...
function library:Window(options)
    ...
    local Fluxus = Instance.new("ScreenGui")
    Fluxus.Name = "Fluxus"
    Fluxus.Parent = game.CoreGui
    Fluxus.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
...
game.CoreGui:FindFirstChild("Fluxus").Enabled = not game.CoreGui:FindFirstChild("Fluxus").Enabled
    ...
    Main_Logo.Text = "F"
    Main_Logo.TextColor3 = Color3.fromRGB(255,255,255)
    Main_Logo.Font = Enum.Font.Code
    Main_Logo.TextScaled = true
